...
function setup() {
  ...
  speed1 = Math.floor(Math.random()*89-54+1)+54;
  speed2 = Math.floor(Math.random()*89-54+1)+54;
  speed3 = Math.floor(Math.random()*89-54+1)+54;
  weight1 = Math.floor(Math.random()*1499-399+1)+399;
  weight2 = Math.floor(Math.random()*1499-399+1)+399;
  weight3 = Math.floor(Math.random()*1499-399+1)+399;
...
text(deformation1, 100, 100);
text(deformation2, 200, 100);
text(deformation3, 300, 100);
